...
export const AUTH_TOKEN = "syncfuse.auth";
export const LOCALE_CONFIG = "syncfuse.locale";
export const TIMEZONE_CONFIG = "syncfuse.timezone";
export const DATE_RANGE_CONFIG = "syncfuse.date-range";
export const THEME_CONFIG = "syncfuse.theme";
export const DASHBOARD_CONFIG = "syncfuse.dashboard";
export const LAST_TEAM_CONFIG = "syncfuse.last-team";
export const VERSION_CHECK = "syncfuse.version-check";
export const SHARE_TOKEN_HEADER = "x-syncfuse-share-token";
export const HOMEPAGE_URL = "https://syncfuse.io";
export const DOCS_URL = "https://syncfuse.io/docs";
export const REPO_URL = "https://github.com/syncfuse/syncfuse";
export const UPDATES_URL = "https://api.syncfuse.io/v1/updates";
export const TELEMETRY_PIXEL = "https://i.syncfuse.io/a.png";
